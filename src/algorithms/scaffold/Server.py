...
class Server(BaseServer):
    ...
    def run(self):
        ...
        for round_idx in range(self.n_rounds):
            ...
            (updated_local_weights, updated_c_amounts, client_sizes, round_results, local_grad_norms) = self._clients_training(sampled_clients)


            # Get aggregated weights & update global
            if (self.algo_params.sync):
                ag_weights = self._aggregation_with_kuramoto(updated_local_weights, client_sizes, local_grad_norms, K_t=0.2, max_sync_clip=1e1)
            else:
    ...
    def _clients_training(self, sampled_clients):
        ...
        for client_idx in sampled_clients:
            ...
            # Local training
            local_results, local_size, c_i_plus, c_update_amount, avg_grad_norm = self.client.train()
        ...
        return updated_local_weights, updated_c_amounts, client_sizes, round_results, local_grad_norms
